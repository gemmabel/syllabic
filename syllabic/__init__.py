...
result = syl("cayn")
print("%s" % result)
result = syl("estudioso")
print("%s" % result)
result = syl("Luiza")
print("%s" % result)
result = syl("monstruosidad")
print("%s" % result)
result = syl("esperandonos")
print("%s" % result)
result = syl("candela")
print("%s" % result)
result = syl("verificaría")
print("%s" % result)
result = syl("estimabamos")
print("%s" % result)
result = syl("miento")
print("%s" % result)
result = syl("extrañamiento")
print("%s" % result)
result = syl("congestiónamiento")
print("%s" % result)
result = syl("Jerusalem")
print("%s" % result)
